...
| 2026-09-09 | screenshots/2026-09-09_serp-vip-golden-number-uae-probizsms.png | Malik's Google SERP for **"vip golden number uae"**: xplate #1, autotraders #2, **probizsms.com/golden-numbers/ #3** ("Golden Numbers — Probiz \| Etisalat by e&"), then AI Overview. goldennummbers.com not visible. Malik read it as a downgrade + a new competitor; probizsms is Probiz's OWN site (Bilal's employer, same office/inventory). See STATE 09-09 |
| 2026-09-09 | screenshots/2026-09-09_gsc-performance-3mo-floor.png | GSC Overview 3-mo (6/7→9/5): 398 clicks total; peaks 7/9 (22) + 7/18 (25); cliff 7/20; **floor 0-3/day unchanged through 9/5**, one 6-click blip ~8/12. NO recovery signal after noindex (8/5) or after the 503 outage ended (8/30). See STATE 09-09 |
| 2026-09-09 | screenshots/2026-09-09_gsc-page-indexing-1510-indexed.png | GSC Page Indexing, Last update **9/4/26**: Indexed **1.51K** (was 4.23K on 8/5) · Not indexed **3.19K** (9 reasons). Grey bars climb from ~8/5 and jump ~8/17 (the 503 window). **The noindex drain is working** — target is ~90-190 |
| 2026-09-09 | screenshots/2026-09-09_gsc-page-indexing-reasons-5xx-1524.png | Not-indexed reasons: **Server error (5xx) 1,524** (the 08-17→08-30 outage, Website source) · Excluded by noindex 1,213 · Alternate canonical 324 · 404 11 · redirect 10 · 4xx 1 · Discovered-not-indexed 77 · Crawled-not-indexed 28 · Duplicate 2. All "Not Started" validation. OPEN: are money pages inside the 5xx bucket? |
| 2026-09-09 | screenshots/2026-09-09_gsc-sitemaps-read-sep8-9.png | Sitemaps all Success: removal 4,247 read Sep 8 · sitemap-numbers 12 read Sep 8 · sitemap.xml 79 read **Sep 9**. Google is crawling again post-outage |
| 2026-09-09 | screenshots/2026-09-09_gsc-5xx-examples-numbers-only.png | GSC 5xx reason → Examples (top 8 by last-crawled): ALL `/numbers/etisalat-*` pages, last crawled **Aug 30, 2026** (the day the 503 was lifted). Number pages are noindex anyway; they will move 5xx→noindex on recrawl. Only 8 of 1,524 seen — full CSV export is the real check |
| 2026-09-09 | refs/2026-09-09_gsc-5xx-drilldown.zip (+ `2026-09-09_gsc-5xx-export/Table.csv`) | GSC Server-error (5xx) drilldown export: 1,000 of 1,524 URLs. 996 number pages + 4 real pages (`/home-wireless/`, vs-du blog, `/golden-number-price-uae/`, home-wireless blog .html). See STATE 09-09 |
| 2026-09-09 | screenshots/2026-09-09_gsc-urlinspect-home-indexed.png + `…-choose-number-indexed.png` | URL Inspection post-outage: `/` and `/choose-number/` both "URL is on Google / Page is indexed". Home: 20 valid Product snippets (non-critical issues). Money pages survived the 503 window |
| 2026-09-09 | screenshots/2026-09-09_gsc-5xx-validation-started.png | GSC Server error (5xx) → Validate fix clicked: "Validation started 9/9/26". Forces recrawl of the 1,524 outage URLs; expect number pages to migrate into the noindex bucket over ~1-2 weeks |
| 2026-09-09 | screenshots/2026-09-09_ahrefs-probizsms-dr0-357rd.png | Ahrefs free checker, probizsms.com: **DR 0**, 418 backlinks (26% dofollow), 357 linking websites (18% dofollow ≈ 64 dofollow domains). They outrank us at DR 0 — the gap is NOT domain authority. See STATE 09-09 |
| 2026-09-09 | screenshots/2026-09-09_ahrefs-goldennummbers-dr0-421rd.png | Ahrefs free checker, goldennummbers.com: **DR 0**, 878 backlinks (11% dofollow), 421 linking websites (10% dofollow ≈ 42 dofollow domains). MORE linking sites than probizsms (357), slightly fewer dofollow (≈42 vs ≈64). Link parity → links are not why they outrank us |
